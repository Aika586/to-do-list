...
>(function ProgressCircle(props, ref) {
  ...
  return (
    <ChakraProgressCircle.Root {...rest} ref={ref}>
      <ChakraProgressCircle.Circle css={{ "--thickness": '2px' }}>
        <ChakraProgressCircle.Track stroke={'transparent'} />
        <ChakraProgressCircle.Range stroke={'white'} strokeLinecap='round' />
      </ChakraProgressCircle.Circle>
      {showValueText && (
        <AbsoluteCenter>
          <ChakraProgressCircle.ValueText fontSize={'16px'} fontWeight='bold'>
            {valueText}
